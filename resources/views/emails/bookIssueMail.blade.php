                              ...
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                  ...
                                  <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#C9BC20;line-height:135%;">
                                    {{ $bookTitle }}</h2>
                                  <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">book has been Issued Successfully </div>
                                </td>
                              </tr>
                            </table>
                          </td>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td valign="top" class="textContent">
                                            <h3 style="color: #333; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 25px; font-weight: bold;margin-top:0;margin-bottom:3px;text-align:left;">Dear {{$studentName}}, </h3><br>
                                            <div style="text-align:left;'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                A new book '{{ $bookTitle }}' has been issued to you on {{ date('Y-m-d', strtotime($issueDate)) }}. We hope you find it insightful and enjoyable.
                                                <br><br>
                                                ...
                                                <br>
                                                Please take good care of the book, and make sure to return it by the due date to avoid any late fees. If the book is returned after the due date, a fine of Rs.{{$fineAmount}}/- will be applied for each day it is overdue, up to a maximum of {{$fineDays}} days.
                                                <br><br>
                                                If you have any questions or concerns, feel free to contact our library team. Happy reading!
                                                <br><br>
                                                Best Regards, <br>
                                                Team Abbas Library.
                                            </div>
